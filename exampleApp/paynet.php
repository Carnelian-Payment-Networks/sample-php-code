<?php
@session_start();
    define("AUTHENTICATION", "https://merchants.paynet.co.in/apipaynet/authenticate_key");
    define("PAYPAGE_URL", "https://merchants.paynet.co.in/apipaynet/generate_payment_page");
    define("VERIFY_URL", "http://merchants.paynet.co.in/apipaynet/uphold_payment");
    define("REFUND_URL", "https://merchants.paynet.co.in/apipaynet/refund_process");
